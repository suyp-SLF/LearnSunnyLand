...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.9.5"
  WORKING_DIRECTORY "/Users/suyp/C++/Projects/LearnSunnyLand/build/_deps/tinygltf-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/suyp/C++/Projects/LearnSunnyLand/build/_deps/tinygltf-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/suyp/C++/Projects/LearnSunnyLand/build/_deps/tinygltf-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
